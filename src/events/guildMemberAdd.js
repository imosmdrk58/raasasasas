...
kayitchannel.wsend(`
Marino'ya Hoşgeldin ${member}! Hesabın ${memberGün} ${memberAylar} ${memberTarih} tarihinde oluşturulmuş. ${guvenilirlik ? `Şüpheli! ${red}` : `Güvenli! ${green}` }\n 
...
Seninle beraber **${üyesayısı}** kişiyiz.Sunucuya Özel URL ile katıldın!`);
...
Sunucuya erişebilmek için "V. Confirmed" odalarında kayıt olup isim yaş belirtmen gerekmektedir.\n
Sunucu kurallarımız ${kurallar} kanalında belirtilmiştir. Unutma sunucu içerisinde ki ceza işlemlerin kuralları okuduğunu varsayarak gerçekleştirilecek.\n
Seninle beraber **${üyesayısı}** kişiyiz.${invite.inviter} tarafından davet edildin ve bu kişinin ${total} daveti oldu!`);
channel.wsend(`${member}, ${invite.inviter.tag} davetiyle katıldı! (**${total}**)`)
}
